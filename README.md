...
Machine learning algorithm used for the model - linear regression 
NumPy library 
Pandas library 
...
Sex - female or male 
BMI - body mass proportion. BMI is the weight of person in kg divided by square of height in cm 
Children - number of children the patient has 
Smoker - whether the person is smoker or not. Yes or no 
Region - region of residence of patient 
Charges - amount of money charged 
